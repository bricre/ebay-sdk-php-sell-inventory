...
/**
 * This type is used by the createInventoryLocation call to provide details on the
 * inventory location, including the location's name, physical address, operating
 * hours, special hours, phone number and other details of an inventory location.
 */
class InventoryLocationFull extends AbstractModel
{
     ...
     * inventory location cannot be modified once set with a createInventoryLocation
     * call. All other details of an inventory location (e.g. phone or operating hours)
     ...
     * an inventory location. Max length: 256.
     *
     * @var string
     */
     ...
     * pickup instructions contained in the merchant's profile (if available).
     *
     * @var string
     */
     ...
     * some cases, an inventory location may be both. If this container is omitted, the
     * location type of the inventory location will default to WAREHOUSE. See
     * StoreTypeEnum for the supported values. Default: WAREHOUSE.
     *
     ...
     * associated with the inventory location. Max length: 512.
     *
     * @var string
     */
     ...
     * to location). If this field is omitted, a successful createInventoryLocation
     * call will automatically enable the inventory location. A merchant may want to
     * create a new inventory location but leave it as disabled if the inventory
     * location is not yet ready for active inventory. Once the inventory location is
     * ready, the merchant can use the enableInventoryLocation call to enable an
     * inventory location that is in a disabled state. See StatusEnum for the supported
     * values. Default: ENABLED For implementation help, refer to <a
     ...
     * published. So, if the seller omits this field in a createInventoryLocation call,
     * it becomes required for an updateInventoryLocation call. Max length: 1000.
     *
     * @var string
     */
    public $name = null;
     ...
     * day of the week. A dayOfWeekEnum field and an intervals container will be needed
     ...
     * to specify the phone number for a store inventory location. Max length: 36.
     *
     * @var string
     */
    public $phone = null;
