...
class AvailabilityDistribution extends AbstractModel
{
     ...
     * corresponding merchantLocationKey field. The fulfillment time is the estimated
     * number of business days after purchase that the buyer can expect the item to be
     * delivered. This field is optional, and is used by eBay to provide the estimated
     * delivery date to buyers. This field is returned if set for the inventory item.
     *
