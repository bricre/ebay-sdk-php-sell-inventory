 ...
 * created and/or updated with the bulkCreateOrReplaceInventoryItem method. Up to
 * 25 inventory item records can be created and/or updated with one call.
 */
class InventoryItemWithSkuLocale extends AbstractModel
{
     ...
     * MANUFACTURER_REFURBISHED enum is used for any of the SKUs in a
     * bulkCreateOrReplaceInventoryItem method, it will be accepted but automatically
     * converted by eBay to CERTIFIED_REFURBISHED. To list an item as 'Certified
     ...
     * seller that is interested in eligibility requirements to list with 'Certified
     ...
     * field is returned in the getInventoryItem, bulkGetInventoryItem, and
     * getInventoryItems calls if a condition description was provided for a used
     * inventory item. Max Length: 1000.
     *
     * @var string
     */
     ...
     * container is returned in the getInventoryItem, bulkGetInventoryItem, and
     * getInventoryItems calls if package type, package weight, and/or package
     * dimensions are specified for an inventory item. See the Calculated shipping help
