...
class AvailabilityWithAll extends AbstractModel
{
     ...
     * stores where the inventory item is available for in-store pickup. The store ID,
     * the quantity available, and the fulfillment time (how soon the item will be
     * ready for pickup after the order occurs) are all returned in this container.
     *
